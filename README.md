...
- 2025 完整自然年矩阵与 2024-12 之后的月度数据使用 HS 2022（UN Comtrade `H6`）；主体商品使用 HS4，化肥总览使用 HS31；盾构机使用 HS 843031/843039 筛查池，工程车使用 HS 870410/870510/870540 整车组合，均可下钻到 HS6 子项。
- 跨越 2022 修订点的五年趋势明确标注为“HS 2017→2022 对照”，不能把编码拆分或合并造成的变化直接解释为贸易趋势。
